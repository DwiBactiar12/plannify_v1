                            ...
                            <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-sm">
                                ...
                                <form className="space-y-6" onSubmit={submit}>
                                    ...
                                    <div className="flex justify-center items-center mt-4">
                                        <Button disable={processing}>Resend Verification</Button>
                                        <Link
                                            href={route('logout')}
                                            method="post"
                                            as="button"
                                            className="text-sm text-muted-foreground underline rounded-md hover:text-foreground focus:outline-none focus:ring-2 focus:ring-red-200 focus:ring-offset-2"
                                        >
                                            Logout
                                        </Link>
                                    </div>
